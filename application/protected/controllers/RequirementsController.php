...
class RequirementsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Requirements']))
		{
			...
			foreach ($_POST['Requirements'] as $key => $value) {
				if(empty($value)) $_POST['Requirements'][$key] = null;
			}
		...
		$this->render('create',array(
			'model'=>$model,
			'attributeList'=>Constants::model()->findAll('type=:type', array(':type'=>Constants::KNIGHTS_ATTRIBUTES)),
			'skillList'=>Constants::model()->findAll('type=:type', array(':type'=>Constants::KNIGHTS_SKILLS)),
		));
	}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Requirements']))
		{
			...
			$model->attributes=$_POST['Requirements'];	//die(var_export($_POST['Requirements'],true));		
			if($model->save())
				$this->redirect(array('view','id'=>$model->id));
		}
