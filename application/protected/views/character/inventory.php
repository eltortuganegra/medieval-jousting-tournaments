<div id="character_inventory">
	...
	<div id="inventory">
		<h1>Sir <?php echo $this->knight->name;?>: inventario</h1>
		<div id="inventory_trader">
			<h3>MERCADO MEDIEVAL</h3>
			<a href="/medievalmarket"><img src="<?php echo Yii::app()->params['statics_cdn'];?>/images/trader.png" /></a>			
		</div>
