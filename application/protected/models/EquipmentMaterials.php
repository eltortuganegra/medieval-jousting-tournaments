...
/**
 * This is the model class for table "equipment_materials".
 *
 * The followings are the available columns in table 'equipment_materials':
 * @property integer $id
 ...
 */
class EquipmentMaterials extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return EquipmentMaterials the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'armours' => array(self::HAS_MANY, 'Armours', 'material'),
		);
	}
