...
/**
 * This is the model class for table "knights_stats_by_date".
 *
 * The followings are the available columns in table 'knights_stats_by_date':
 * @property string $id
 ...
 * @property integer $tricks_total_received_successful
 ...
 */
class KnightsStatsByDate extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return KnightsStatsByDate the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('knights_id, date', 'required'),
			array('tricks_total_received_successful', 'numerical', 'integerOnly'=>true),
			array('knights_id, combats_wins, combats_wins_injury, combats_draw, combats_draw_injury, combats_loose, combats_loose_injury, hits_total_produced, hits_total_blocked, hits_total_received, hits_total_received_blocked, damage_total_produced, damage_total_received, damage_maximum_produced, damage_maximum_received, injury_total_light_produced, injury_total_light_received, injury_total_serious_produced, injury_total_serious_received, injury_total_very_serious_produced, injury_total_very_serious_received, injury_total_fatality_produced, injury_total_fatality_received, money_total_earned, money_maximum_earned_combat, tricks_total_used, tricks_total_used_successful, tricks_total_received, desquality_produced, desquality_received', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, knights_id, combats_wins, combats_wins_injury, combats_draw, combats_draw_injury, combats_loose, combats_loose_injury, hits_total_produced, hits_total_blocked, hits_total_received, hits_total_received_blocked, damage_total_produced, damage_total_received, damage_maximum_produced, damage_maximum_received, injury_total_light_produced, injury_total_light_received, injury_total_serious_produced, injury_total_serious_received, injury_total_very_serious_produced, injury_total_very_serious_received, injury_total_fatality_produced, injury_total_fatality_received, money_total_earned, money_maximum_earned_combat, tricks_total_used, tricks_total_used_successful, tricks_total_received, tricks_total_received_successful, date, desquality_produced, desquality_received', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('tricks_total_received_successful',$this->tricks_total_received_successful);
