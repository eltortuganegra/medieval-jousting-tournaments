...
/**
 * This is the model class for table "knights_stats".
 *
 * The followings are the available columns in table 'knights_stats':
 ...
 */
class KnightsStats extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return KnightsStats the static model class
	 */
